...
$this->title = 'leaders-sales-department';
...
<section class="department">
    <div class="header-section">
        <h1 class="header-section__title title34">Руководители отдела продаж</h1>
    ...
    <div class="info-block department__table">
        <div class="department__columns">
            ...
            <div class="title14 department__menegers department__title">К-во менеджеров в подчинении</div>
        </div>
        <div class="department__rows">
            ...
            ?>
                <div class="department__row">
                    ...
                    <div class="title14 department__menegers department__title">25</div>
